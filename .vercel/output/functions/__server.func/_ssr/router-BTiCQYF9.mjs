...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BTiCQYF9.js
var router_BTiCQYF9_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CndvC6Bo.css";
var APP_NAME = "Ludo Court";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A full Ludo match for two to four houses — humans and sharp AI, on a teak court."
			},
			{
				name: "theme-color",
				content: "#12110e"
...
var $$splitComponentImporter = () => import("./routes-D4NsJzmM.mjs");
...
//#endregion
export { getRouter, router_BTiCQYF9_exports as t };
